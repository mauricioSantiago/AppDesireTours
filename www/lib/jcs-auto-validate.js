...
angular.autoValidate.errorMessages['default'] = {
  ...
  email: 'Ingrese un correo electrico valido.',
  minlength: 'El número de caracteres debe de ser mayor a {0}.',
  maxlength: 'El número de caracteres debe de ser menor a {0}.',
  min: 'El valor debe ser mayor a {0}',
  max: 'El valor debe ser menor a {0}',
